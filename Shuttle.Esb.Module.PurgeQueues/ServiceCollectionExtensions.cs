...
namespace Shuttle.Esb.Module.PurgeQueues
{
    ...
    {
        public static IServiceCollection AddPurgeQueuesModule(this IServiceCollection services,
            Action<PurgeQueuesBuilder> builder = null)
        {
            ...
            services.TryAddSingleton<PurgeQueuesModule, PurgeQueuesModule>();
            ...
            services.AddPipelineModule<PurgeQueuesModule>();
